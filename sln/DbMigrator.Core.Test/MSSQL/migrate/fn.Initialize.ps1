function Initialize{
	...
	$xConfig = [xml] (get-content ($global:drive + ':\Projetos\DBMigrator\sln\DbMigrator.Core.Test\migrate\config-'+$config+'.xml'))
	...
	$global:migratorExe = ':\Projetos\DBMigrator\sln\DbMigrator.Core.Test\migrate\DBM.exe'
	$global:startDirectory = ':\Projetos\DBMigrator\sln\DbMigrator.Core.Test\migrate'
